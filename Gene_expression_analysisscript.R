# Read in the table that lists the inheritence of the files from galaxy
...
png(filename="histogram_lengths.png", units="in", width=2, height=2, pointsize=4, res=1200)
par(font.axis=2,font.lab=2)
hist(log(rnaseq[,62], base=2), col="gray", las=1, cex.axis=0.8,xlab="length of transcript",main="")
...
png(filename="totalcountsbeforeandafternormalisation.png", units="in", width=3, height=2 , pointsize=6, res=1200)
...
par(font.axis=2,font.lab=2)
boxplot(log(rnaseq[,85:90], base=2),col="gray", las=2,ylab="Foldchange (log2 scale)", lty=1, pch=18)
dev.off()
...
par(font.axis=2,font.lab=2)
hist(log(rnaseq[,79], base=2), col="gray", las=1, cex.axis=0.8,xlab="log2 mean transcript expression",main="")
...
par(font.axis=2,font.lab=2)
hist(log(rnaseq[,80], base=2), col="gray", las=1, cex.axis=0.8,xlab="log2 mean SD transcript expression",main="")
...
dev.off()
png(filename="S1_B2.png", units="in", width=2, height=2 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
...
dev.off()
rnaseq_combined<-rnaseq[,c(1,75:78)]
...
library("gplots")
png(filename="Me_heatmap_final.png", units="in", width=2, height=4 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
...
dev.off()
png(filename="Me_Zscore_summed_barplot.png", units="in", width=1.5, height=1.5 , pointsize=5, res=1200)
...
abline(h=0)
dev.off()
png(filename="Me_Expression_summed_barplot.png", units="in", width=1.5, height=1.5 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
x<-colSums(Me[,75:78])
x_up<-max(x)+200
...
box()
dev.off()
png(filename="ES_heatmap_final.png", units="in", width=2, height=7 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
...
dev.off()
png(filename="ES_Zscore_summed_barplot.png", units="in", width=1.5, height=1.5 , pointsize=5, res=1200)
...
abline(h=0)
dev.off()
png(filename="ES_Expression_summed_barplot.png", units="in", width=1.5, height=1.5 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
x<-colSums(ES[,75:78])
x_up<-max(x)+200
barplot(x,las=1,ylab="Summed Tpkm",names =c("S1","S2","S3","S4"),ylim=c(0,x_up))
box()
dev.off()
png(filename="iPSC_heatmap_final.png", units="in", width=2, height=7 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
x<-heatmap.2(as.matrix(iPSC[,75:78]), col=greenred(75),
             ...
             keysize=0.6, key.par=list(mar=c(3.5,1,6,0)))
dev.off()
png(filename="iPSC_Zscore_summed_barplot.png", units="in", width=1.5, height=1.5 , pointsize=5, res=1200)
...
abline(h=0)
dev.off()
png(filename="iPSC_Expression_summed_barplot.png", units="in", width=1.5, height=1.5 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
...
# fold change
png(filename="FoldChange.png", units="in", width=2, height=2 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
Me[,87]<-Me[,78]/Me[,75]
ES[,87]<-ES[,78]/ES[,75]
...
#Eggplots
png(filename="egg_plot_S1_S4.png", units="in", width=2, height=2 , pointsize=6, res=1200)
par(mar=c(4,3,2,2))
...
dev.off()
png(filename="eggplots.png", units="in", width=4, height=3 , pointsize=6, res=1200)
par(mfrow=c(2,3))
...
library(ggplot2)
library(gridExtra)
png(filename="histogram2.png", units="in", width=5, height=5 , pointsize=3, res=1200)
t<-(Me[,c(81,84)])
...
png(filename="histogram2D_custom_ME.png", units="in", width=2, height=2 , pointsize=4, res=1200)
ds =(Me[,c(81,84)])
with(ds, scatterhist(S1_zscore,S4_zscore, ylab="S4_Me", xlab="S1_Me"))
dev.off()
png(filename="histogram2D_custom_ES.png", units="in", width=2, height=2 , pointsize=4, res=1200)
ds =(ES[,c(81,84)])
with(ds, scatterhist(S1_zscore,S4_zscore, ylab="S4_ES", xlab="S1_ES"))
dev.off()
png(filename="histogram2D_custom_iPSC.png", units="in", width=2, height=2 , pointsize=4, res=1200)
ds =(iPSC[,c(81,84)])
with(ds, scatterhist(S1_zscore,S4_zscore, ylab="S4_iPSC", xlab="S1_iPSC"))
dev.off()
png(filename="histogram2D_custom.png", units="in", width=2, height=2 , pointsize=4, res=1200)
ds =(rnaseq_mapped_genes[,c(81,84)])
with(ds, scatterhist(S1_zscore,S4_zscore, ylab="S4_zscore", xlab="S1_zscore"))
dev.off()
...
png(filename="combined_norm_candidate_genes.png", units="in", width=2, height=2 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
plot(log10(candidate_genes_expression[,75:78]), lower.panel = panel.cor,upper.panel = upper.panel.col)
dev.off()
png(filename="combined_norm_Me.png", units="in", width=2, height=2 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
plot(log10(Me[,75:78]), lower.panel = panel.cor,upper.panel = upper.panel)
dev.off()
png(filename="combined_norm_ES.png", units="in", width=2, height=2 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
plot(log10(ES[,75:78]), lower.panel = panel.cor,upper.panel = upper.panel)
dev.off()
png(filename="combined_norm_iPSC.png", units="in", width=2, height=2 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
...
library("corrplot")
png(filename="top_exons.png", units="in", width=2, height=2 , pointsize=6, res=1200)
...
png(filename="top_exons_final.png", units="in", width=3, height=3 , pointsize=8, res=1200)
par(font.axis=2,font.lab=2)
...
library("corrplot")
png(filename="top_genes.png", units="in", width=2, height=2 , pointsize=6, res=1200)
corrplot(as.matrix(top_10_percent),is.corr=F, tl.col="black",cl.pos="b", cl.ratio=0.3)
dev.off()
temp<-top_10_percent
colnames(temp)<-c("3 Hour","3 Days","6 Days","10 Days")
png(filename="top_genes_final.png", units="in", width=3, height=3 , pointsize=8, res=1200)
par(font.axis=2,font.lab=2)
corrplot(as.matrix(temp),is.corr=F, tl.col="black",cl.pos="b", cl.ratio=0.3,method="color",addgrid.col="black")
dev.off()
...
png(filename="Mesenchymal_topgenes_heatmap.png", units="in", width=2, height=5 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
x<-heatmap.2(as.matrix(selected_topgenes[,75:78]), col=redgreen(75),
             ...
             keysize=0.6, key.par=list(mar=c(2,1,3,0)))
dev.off()
...
temp[,90]<-"ES"
png(filename="ES_topgenes_heatmap.png", units="in", width=2, height=5 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
...
temp[,90]<-"iPSC"
png(filename="iPSC_topgenes_heatmap.png", units="in", width=2, height=5 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
x<-heatmap.2(as.matrix(temp[,75:78]), col=redgreen(75),
             scale="row",key=T, symkey=T, Rowv=F,Colv=FALSE,cexRow=0.5,key.xlab="",cex.axis=1,
             trace='none',dendrogram="none",cexCol=0.7,srtCol =90,key.title=" ",
             ylab = "",labRow = temp[,1],labCol=c("S1","S2","S3","S4"),density.info="none",
             keysize=0.6, key.par=list(mar=c(2,1,3,0)))
dev.off()
selected_topgenes<-rbind(selected_topgenes,NA,NA,temp)
png(filename="selected_topgenes_orderd_type_heatmap.png", units="in", width=2, height=6 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
x<-heatmap.2(as.matrix(selected_topgenes[,75:78]), col=redgreen(75),
             scale="row",key=T, symkey=T, Rowv=F,Colv=FALSE,cexRow=0.2,key.xlab="",
             trace='none',dendrogram="none",cexCol=0.7,srtCol =90,key.title=" ",
             ylab = "",labRow = selected_topgenes[,1],labCol=c("S1","S2","S3","S4"),density.info="none",
             keysize=0.6, key.par=list(mar=c(2,1,7,0)))
dev.off()
S1_topgenes<-as.data.frame(rbind(m1,NA,e1,NA,i1))
S1_topgenes[,90]<-"S1"
png(filename="S1_candidate_topgenes_heatmap.png", units="in", width=2, height=4 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
...
S2_topgenes[,90]<-"S2"
png(filename="S2_candidate_topgenes_heatmap.png", units="in", width=2, height=4 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
...
S3_topgenes[,90]<-"S3"
png(filename="S3_candidate_topgenes_heatmap.png", units="in", width=2, height=5 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
...
S4_topgenes[,90]<-"S4"
png(filename="S4_candidate_topgenes_heatmap.png", units="in", width=2, height=5 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
...
png(filename="selected_topgenes_orderd_Sample_heatmap.png", units="in", width=2, height=6 , pointsize=5, res=1200)
par(font.axis=2,font.lab=2)
x<-heatmap.2(as.matrix(selected_topgenes[,75:78]), col=redgreen(75),
...
for( i in 1:nrow(imp_genes)){
  png(filename=paste("imp_gene",i,".png",sep=""), units="in", width=1.5, height=1.5 , pointsize=4, res=300)
  par(font.axis=2,font.lab=2)
...
library("gplots")
png(filename="epitect_rna_heatmap.png", units="in", width=2, height=5 , pointsize=6, res=1200)
par(font.axis=2,font.lab=2)
x<-heatmap.2(as.matrix(rna_epi[,75:78]), col=greenred(75),
             ...
             keysize=0.6, key.par=list(mar=c(3.5,1,2.5,0)))
dev.off()
png(filename="epitect_heatmap.png", units="in", width=2, height=5 , pointsize=6.5, res=1200)
par(font.axis=2,font.lab=2)
...
png(filename="epitectvsrnaseq_zscore.png", units="in", width=3, height=3 , pointsize=6, res=1200)
...
t[is.na(t)]<-0
c<-cor(t[2:9])
png(filename="epitectvsrnaseq_zscore_cor.png", units="in", width=3, height=3 , pointsize=6, res=1200)
corrplot(c, method="color",tl.col="black" )
dev.off()

t<-merge(rna_epi[,c(1,75:78)], epitect, by="name")
png(filename="epitectvsrnaseq.png", units="in", width=3, height=3 , pointsize=6, res=1200)
par(mfrow=c(2,2))
plot(t[,2]~t[,6], pch=18, main="S1",xlab="epitect",ylab="rnaseq", las=1)
plot(t[,3]~t[,7], pch=18, main="S2",xlab="epitect",ylab="rnaseq", las=1)
plot(t[,4]~t[,8], pch=18, main="S3",xlab="epitect",ylab="rnaseq", las=1)
...
dev.off()
c<-cor(t[2:9])
png(filename="epitectvsrnaseq_cor.png", units="in", width=3, height=3 , pointsize=6, res=1200)
corrplot(c, method="color", tl.col="black")
dev.off()
...
png(filename="Epi_RNA_genes_sum.png", units="in", width=3, height=6 , pointsize=6, res=1200)
...
png(filename="Epi_RNA_genes_mean.png", units="in", width=3, height=6 , pointsize=6, res=1200)
par(mfrow=c(4,2),font.axis=2,font.lab=2)
k<-as.matrix(temp_rna[1,-1])
barplot(k, las=1, horiz = T, main="Epithelial_RNAseq")
box()
